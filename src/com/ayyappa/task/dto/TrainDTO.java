...
public class TrainDTO {
	...
	private String destinaation;
	private int train_seat_No;
	private int price;
	private String train_class;
	private String name;

	public TrainDTO(int train_id, int train_no, String boarding, String destinaation, int train_seat_No, int price,
	...
	public String toString() {
		return "TrainDTO [train_id=" + train_id + ", train_no=" + train_no + ", boarding=" + boarding
				+ ", destinaation=" + destinaation + ", train_seat_No=" + train_seat_No + ", price=" + price
